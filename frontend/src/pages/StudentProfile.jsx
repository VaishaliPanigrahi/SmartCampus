...
function StudentProfile({ onLogout }) {
  ...
  return <main className="min-h-screen bg-ink px-6 py-6 text-white lg:px-10">
    ...
    <section className="mx-auto max-w-7xl py-12">
      <div className="mb-8 flex flex-wrap items-center gap-3"><a className="button-secondary gap-2 px-3 py-2" href="/student/dashboard"><ArrowLeft size={15} /> Dashboard</a><a className="button-secondary gap-2 px-3 py-2" href="/student/resume">Resume analysis</a><a className="button-secondary gap-2 px-3 py-2" href="/student/applications">Applications</a><a className="button-primary gap-2 px-3 py-2" href="/student/recommendations">Recommended jobs</a></div>
